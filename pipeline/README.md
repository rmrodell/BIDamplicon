...
Perform analysis for statistical difference and equivalence of sites.
...
2. Data Loading & Validation: It loads the input data table and verifies that all required columns are present. Required columns should be generated by the counting script if used properly. Required columns are:
    ...
    - treat: values should be in / input and BS / BID; column the statistics are performed between
    - rep: indicates replicate number, need to have at least two
