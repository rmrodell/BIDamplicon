...
7. Remove Multi-Aligners: Removes any reads that map to multiple locations within the reference, retaining only those that have a single primary alignment.
